...
export const _container = (width, horizontal, backgroundColor, borderRadius) => ({
  width: width,
  backgroundColor,
...
export const _increaseButtonStyle = (isPressed, increaseButtonBackgroundColor) => ({
  width: 40,
  height: 40,
  borderRadius: 16,
  alignItems: "center",
...
export const _decreaseButtonStyle = (isPressed, decreaseButtonBackgroundColor) => ({
  width: 40,
  height: 40,
  borderRadius: 16,
  alignItems: "center",
